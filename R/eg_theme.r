theme_nyloncalc <- function(base_size = 12,base_family="") {
  theme(
        ...
        axis.text.x =           element_text(size=12,colour="black",face="bold",family="Lato"),
        axis.text.y =           element_text(size=12,colour="black",face="bold",family="Lato"),
        ...
        axis.ticks.margin =     unit(0.1, "cm"),asdf
