...
print_eg <- function(base_size = 7,base_family="") {
  theme(
        line =                  element_line(colour = "black", size = 0.5, linetype = 1,lineend = "butt"),
        rect =                  element_rect(fill = "white", colour = "black", size = 0.5, linetype = 1),
        text =                  element_text(family = base_family, face = "plain",colour = "black", size = base_size,hjust = 0.5, vjust = 0.5, angle = 0, lineheight = 0.9),
        ...
        axis.line =             element_blank(),
        axis.text.x =           element_text(size=7,colour="black",family="Lato"),
        axis.text.y =           element_text(size=7,colour="black",family="Lato"),
        axis.ticks =            element_blank(),
        axis.ticks.x =          element_line(colour="#ffffff",size=.25),
        axis.title.x =          element_text(size=8,colour="black",face="bold",family="Lato",vjust=-.2),
        axis.title.y =          element_text(size=8,colour="black",face="bold",family="Lato",angle=90,vjust=0.8),
        axis.ticks.length =     unit(0.15, "cm"),
        axis.ticks.margin =     unit(0.1, "cm"),
        axis.line.y =           element_line(colour="#ffffff",size=2),
